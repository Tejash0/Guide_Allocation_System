...
export async function getProjectTemplates() {
  return apiFetch(`${BASE}/project-templates`, { headers: headers() });
}

export async function saveProjectTemplate(title, description, tech_stack) {
  return apiFetch(`${BASE}/project-templates`, {
    method: 'POST',
    headers: headers(),
...
export async function deleteProjectTemplate(id) {
  return apiFetch(`${BASE}/project-templates/${id}`, {
    method: 'DELETE',
    headers: headers(),
  });
}
...
export async function getProjectComments() {
  return apiFetch(`${BASE}/project-comments`, { headers: headers() });
}

export async function replyToComment(comment) {
  return apiFetch(`${BASE}/project-comments`, {
    method: 'POST',
    headers: headers(),
